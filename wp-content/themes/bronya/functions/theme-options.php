...
function custom_theme_options() {
	...
	$custom_settings = array(
		...
		'settings'        => array(
			...
			array(
				...
				'settings'     => array(
					array(
						'id'           => 'header_sect_menu_item_link',
						'label'        => 'Якор',
						'desc'         => 'Треба ввести ID блоку, на який буде скролити пункт меню <br>* обов\'язково вказати "#" перед ID',
						'std'          => '',
						'type'         => 'text',
					),
					array(
						'id'           => 'header_sect_menu_item_offset',
						'label'        => 'Відступ',
						'desc'         => 'Відступ скролу від верхньої точки секції',
						'std'          => '0',
						'type'         => 'numeric-slider',
						'rows'         => '',
						'post_type'    => '',
			...
			array(
				'id'           => 'first_section_link',
				'label'        => 'Посилання',
				'desc'         => 'Посилання по кнопці "Приєднатися"',
				'std'          => '',
				'type'         => 'text',
				'section'      => 'first_section',
			),
			array(
				'id'           => 'first_section_video_tab',
				'label'        => 'Відео в попапі',
				'desc'         => '',
				'type'         => 'tab',
				'section'      => 'first_section',
			),
			array(
				'id'           => 'first_section_video_switcher',
				'label'        => 'Спосіб відображення відео',
				'desc'         => 'Посилання (наприклад з youtube), або завантажити на сайт',
				'std'          => 'youtube',
				'type'         => 'radio',
				'rows'         => '',
				'post_type'    => '',
				...
				'choices'      => array(
					array(
						'value' => 'youtube',
						'label' => 'Відео з youtube, або інше посилання на відео',
						'src'   => '',
					),
					array(
						'value' => 'load',
						'label' => 'Завантажити відео на сайт',
						'src'   => '',
					),
				),
			),
			array(
				'id'           => 'first_section_video_link',
				'label'        => 'Посилання',
				'desc'         => 'Посилання на відео',
				'std'          => '',
				'type'         => 'text',
				'section'      => 'first_section',
				'condition'    => 'first_section_video_switcher:is(youtube)',
			),
			array(
				'id'           => 'first_section_video_video',
				'label'        => 'Завантажити відео на сайт',
				'desc'         => 'Завантажте відео',
				'std'          => '',
				'type'         => 'upload',
				'condition'    => 'first_section_video_switcher:is(load)',
				'section'      => 'first_section',
			),

			array(
				'id'           => 'about_on_off',
				'label'        => 'Показати/скрити секцію',
				'desc'         => '',
				'std'          => 'on',
				'type'         => 'on-off',
				'section'      => 'about',
			...
			array(
				...
				'settings'     => array(
					array(
						'id'           => 'about_list_item_switcher',
						'label'        => 'Тип блоку',
						'desc'         => 'Оберіть тип блоку (зображення або текстовий)',
						'std'          => 'textblock',
						'type'         => 'radio',
						'rows'         => '',
						'post_type'    => '',
					...
					array(
						'id'           => 'about_list_item_icon',
						'label'        => 'Іконка',
						'desc'         => 'Завантажте іконку',
						'std'          => '',
						'type'         => 'upload',
						'condition'    => 'about_list_item_switcher:is(textblock)',
					),
					array(
						'id'           => 'about_list_item_content',
						'label'        => 'Опис блоку',
						'desc'         => '',
						'std'          => '',
						'type'         => 'textarea',
					...
					array(
						'id'           => 'about_list_item_image',
						'label'        => 'Зображення',
						'desc'         => 'Завантажте зображення',
						'std'          => '',
						'type'         => 'upload',
						'condition'    => 'about_list_item_switcher:is(image)',
					),
				),
			),

			array(
				'id'           => 'for_whom_main_tab',
				'label'        => 'Основна інформація',
				'desc'         => '',
				'type'         => 'tab',
				'section'      => 'for_whom',
			...
			array(
				...
				'settings'     => array(
					array(
						'id'           => 'for_whom_list_item_desc',
						'label'        => '',
						'desc'         => 'Вставте опис переваги вище',
						'std'          => '',
			...
			array(
				'id'           => 'for_whom_quote_photo',
				'label'        => 'Фото автора цитати',
				'desc'         => '',
				'std'          => '',
				'type'         => 'upload',
				'section'      => 'for_whom',
			...
			array(
				...
				'settings'     => array(
					...
					array(
						'id'           => 'advantages_list_item_content',
						'label'        => 'Опис блоку',
						'desc'         => '',
						'std'          => '',
						'type'         => 'textarea',
			...
			array(
				'id'           => 'sect_join_events_list_items',
				'label'        => 'Список івентів',
				'desc'         => '',
				'std'          => '',
				'type'         => 'list-item',
				'section'      => 'sect_join',
				'settings'     => array(
					array(
						'id'           => 'sect_join_events_list_item_content',
						'label'        => 'Текст блоку',
						'desc'         => '',
						'std'          => '',
						'type'         => 'textarea',
			...
			array(
				...
				'settings'     => array(
					array(
						'id'           => 'sect_join_plans_list_item_bonus',
						'label'        => 'Бонус тарифу',
						'desc'         => '',
						'std'          => '',
						'type'         => 'text',
					...
					array(
						'id'           => 'sect_join_plans_list_item_old_price',
						'label'        => 'Стара ціна',
						'desc'         => '',
						'std'          => '',
						'type'         => 'text',
					...
					array(
						'id'           => 'sect_join_plans_list_item_price',
						'label'        => 'Ціна',
						'desc'         => '',
						'std'          => '',
						'type'         => 'text',
					...
					array(
						'id'           => 'sect_join_plans_list_item_period',
						'label'        => 'Період',
						'desc'         => '',
						'std'          => '',
						'type'         => 'text',
  ...
  {{demo_background}}
	...
	/**
	 * Переименование стандартного заголовка в list-item
	 */
	function filter_list_item_title_label( $label, $id ) {


    	$label = __( 'Заголовок', 'theme-domain' );

    	if ($id == 'sing_or_donate_sign_list_items' || $id == 'sing_or_donate_donate_list_items' ) {
    		$label = __( 'Сума', 'theme-domain' );
    		return $label;
    	}

    	if ($id == 'for_whom_list_items' ) {
    		$label = __( 'Текст', 'theme-domain' );
    		return $label;
    	}

    	if ($id == 'header_sect_menu_items' ) {
    		$label = __( 'Назва пункта меню', 'theme-domain' );
    		return $label;
    	}
